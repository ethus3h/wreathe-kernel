...
__attribute__((section("__versions"))) = {
	...
	{ 0x1bb37165, __VMLINUX_SYMBOL_STR(arpt_register_table) },
	{ 0x51bfbe9c, __VMLINUX_SYMBOL_STR(arpt_alloc_initial_table) },
	{ 0x50c55d6f, __VMLINUX_SYMBOL_STR(arpt_do_table) },
	{ 0x15a1c9ef, __VMLINUX_SYMBOL_STR(arpt_unregister_table) },
};
