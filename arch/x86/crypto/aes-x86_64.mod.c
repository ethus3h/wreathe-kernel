...
__attribute__((section("__versions"))) = {
	...
	{ 0xfec82c23, __VMLINUX_SYMBOL_STR(crypto_register_alg) },
	{ 0x49dde2b9, __VMLINUX_SYMBOL_STR(crypto_aes_set_key) },
	{ 0xcc1e40f, __VMLINUX_SYMBOL_STR(crypto_it_tab) },
	{ 0x5a70f65a, __VMLINUX_SYMBOL_STR(crypto_unregister_alg) },
};
